...
export const SubAgentIndicator = React.memo<SubAgentIndicatorProps>(
  ({ subAgent, onClick }) => {
    ...
    return (
      <button
        onClick={onClick}
        className="flex items-start gap-3 w-full p-4 bg-secondary border border-border rounded-lg text-left transition-colors hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-ring"
      >
