...
# Ensure any previous imports that used stubbed Temporal definitions are
# cleared so the real implementations can be re-imported.
sys.modules.pop("temporal_workflow", None)
sys.modules.pop("agent_activities", None)
